...
class CameraAccessory extends BaseAccessory_1.default {
    ...
    configureDoorbell() {
        ...
        const schema = (_a = this.getSchema(...SCHEMA_CODE.DOORBELL_RING, ...SCHEMA_CODE.ALARM_MESSAGE)) !== null && _a !== void 0 ? _a : doorbellSchema;
    ...
    async onDeviceStatusUpdate(status) {
        ...
        if (doorbellSchema) {
            ...
            if (doorbellRingStatus && doorbellRingStatus.value.length > 1) { // Compared with '1' in order to filter value '$'
                ...
                (0, ProgrammableSwitchEvent_1.onProgrammableSwitchEvent)(this, this.getDoorbellService(), doorbellExistStatus);
            }
        }
